...
static void mlpackMainPredict(); // This is typically defined after this include.
...
// Nothing else needs to be defined---the binding will use mlpackMainPredict() as-is.
