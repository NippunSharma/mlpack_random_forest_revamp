...
static void mlpackMainFit(); // This is typically defined after this include.
...
// Nothing else needs to be defined---the binding will use mlpackMainFit() as-is.
